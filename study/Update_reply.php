...
<div class="dap_ins">
	<form action="Update_reply_action.php?id=<?php echo $id; ?>" method="post">
    ...
    $content = $row['content'];
    ?>
	<input class="reply_content" name="re_content"  id="re_content" style="width : 600px;" value ="<? echo $content?>" placeholder="내용을 입력해주세요" ></input>
