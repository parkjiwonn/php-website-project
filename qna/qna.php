...
<html lang="en">
    ...
    <h5>Hello, world!</h5>
        ...
        <div id="jb-container">
            ...
            <div id="jb-content">
                ...
                <table class="table">
                    ...
                    <?
                             ...
                             $sql2 = "select * from qna order by no desc limit $start_num, $list";  
                             ...
                             while($board = mysqli_fetch_array($result2)){
                                 ...
                                 $sql3="select * from answer where con_num=".$board['no']."";
                                 $result3=mysqli_query($db, $sql3);
                    ...
                    <tr>
                        ...
                        <td><a href='Qview.php?no=<?php echo $board["no"]; ?>'><?php echo $title; ?><span class="re_ct">[<?php echo $rep_count; ?>]</span></a></td>
                        <td ><?=$board['name']?></td>
                        <td ><?=$board['regdate']?></td>
                        <td ><?=$board['hit']; ?></td>
                        <?
                ...
                <div style='float : right;'>
                    <button
                        ...
                        onclick="location.href='../qna/Qwrite.php'">글 작성</button>
            ...
            <div id="jb-sidebar">
            <h2>게시글 검색</h2>
                <form action ="Qsearch_result.php" method="post">
