...
<header>
  ...
  <!-- Fixed navbar -->
  <nav class="navbar navbar-expand-sm navbar-dark fixed-top bg-black">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        if(isset($_SESSION['no'])){ ?>
            ...
            <div class="nav-link active margin-left"><?=$_SESSION['mb_nick']?>님, 어서오세요.</div>
           
           <?php } else{?>

            <div class="nav-link active margin-left"> 로그인 하신 후 이용해주세요.</div>
        ...
        if(isset($_SESSION['no'])){ ?>
          <button type="button" class="btn btn-outline-light margin" onClick="location.href='../login/logout.php'" >로그아웃</button>
           <?php } else{?>

        <button type="button" class="btn btn-outline-light margin" onClick="location.href='../login/login_view.php'">로그인</button>
              
        <button type="button" class="btn btn-outline-light" onClick="location.href='../login/join.php'">회원가입</button>
        <? } ?>
